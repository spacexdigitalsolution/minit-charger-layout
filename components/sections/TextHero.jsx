  ...
  return (
    <section className="bg-ink-950 py-24 text-center" id={id}>
      <div className="mx-auto max-w-[800px] px-6 lg:px-8">
        <h1 className="font-display mt-3 text-4xl font-semibold tracking-tight sm:text-5xl text-white">
          {title}
        </h1>
        {subtitle && (
          <p className="mt-4 text-sm text-mist font-mono uppercase tracking-wider">
            {subtitle}
          </p>
        )}
      </div>
