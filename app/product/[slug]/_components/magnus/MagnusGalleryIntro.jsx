...
export default function MagnusGalleryIntro({ data }) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1fr] gap-14 items-start">
          ...
          <div>
            ...
            <div className="flex gap-3.5 flex-wrap mt-7.5">
              <Button href="#assessment" className="bg-gradient-to-b from-[#6BFFB1] to-volt text-[#04150C] shadow-volt px-[26px] py-[14px] rounded-full font-body font-semibold text-[15px] transition-all hover:brightness-110 hover:-translate-y-[1px]">
                Request a Quote
              </Button>
              <Button href="#spec-sheet" variant="outline" className="border-[#DEE6D2] text-[#101A13] hover:bg-[#101A13]/5 px-[26px] py-[14px] rounded-full font-body font-semibold text-[15px] transition-all hover:-translate-y-[1px]">
                Download Spec Sheet
              </Button>
            </div>
          </div>
